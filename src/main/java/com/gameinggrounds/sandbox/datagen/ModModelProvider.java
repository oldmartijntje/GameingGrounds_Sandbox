...
public class ModModelProvider extends FabricModelProvider {
    ...
    public void generateBlockStateModels(BlockStateModelGenerator blockStateModelGenerator) {
        blockStateModelGenerator.registerSimpleCubeAll(ModBlocks.RED_SUGAR_DEEPSLATE_ORE);
        blockStateModelGenerator.registerSimpleCubeAll(ModBlocks.RED_SUGAR_ORE);
    }

    @Override
    public void generateItemModels(ItemModelGenerator itemModelGenerator) {
        itemModelGenerator.register(ModItems.DRILL, Models.GENERATED);
        itemModelGenerator.register(ModItems.RED_SUGAR, Models.GENERATED);
        ...
        itemModelGenerator.register(ModItems.GOLD_TRADING_CARD_PACK, Models.HANDHELD);
        itemModelGenerator.register(ModItems.DIAMOND_TRADING_CARD_PACK, Models.HANDHELD);
        itemModelGenerator.register(ModItems.OBSIDIAN_TRADING_CARD_PACK, Models.HANDHELD);
